        ...
        <div class="row">
            <div class="col-lg-8 col-12">
                <div class="property-listing">
                    <div class="title">
                        <h2 style="font-size: 2rem;"><span class="service_name_jquery">Local Listings</span> servicing <?php echo get_term(($area_id))->name ?></h2>
                        <div class="sorting">
                            <label>Sort By</label>
                            <form method="post" action="/wp-admin/admin-ajax.php?action=listing_search_form" class="listing_search">
                    ...
                    if (isset($combined[0]['ID'])) {
                        foreach ($combined as $key => $to_list) {
                            ...
                            <div class="property-item">
                                <div class="details">
                                    <h3><a href="/service-listings/<?php echo get_query_var('region_slug'); ?>/<?php echo get_query_var('area_slug'); ?>/<?php echo get_query_var('service_slug'); ?>/<?php echo get_query_var('listing_slug'); ?><?php echo $list->post_name; ?>" style="color:#000;"><?php echo get_post_meta($list->ID, 'listing_information_group_business_name', true); ?></a></h3>
                                    <ul>
                                        ...
                                        <?php if (get_post_meta($list->ID, 'contact_group_contact_mobile', true)) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if($listings_info_group['additional_listing_view_text_below_number'] != '') {?>
                                        ...
                                        <?php if($listings_info_group['additional_listing_view_text_below_content'] != '') {?>
                                    ...
                                    <div style="padding-top:5px;">
                                        ...
                                        <?php if ($listings_info_group['include_abicon_abnn_icon'] == 'Yes') { ?>
                                            <img src="https://wp-content/uploads/2022/10/abn.png" title="ABN Listing" class="business_icons_small">
                                        <?php } ?>
                                        <?php if ($listings_info_group['icon_insured'] == 'Yes') { ?>
                                            <img src="https://wp-content/uploads/2022/10/insured.png" title="Insured Listing" class="business_icons_small">
                                        <?php } ?>
                                        <?php if ($listings_info_group['icon_licenced'] == 'Yes') { ?>
                                            <img src="https://wp-content/uploads/2022/10/licenced.png" title="Licenced Listing" class="business_icons_small">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="reviews">
                        ...
                        ?>
                        <h4 class='listingnotfound'>
                            Sorry, there are no local businesses listed in this area yet!<br>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="area_id">
                                <?php foreach ($locations as $location) { ?>
                                    <optgroup label="<?php echo $location->name ?>" style="font-size: 16px;padding:10px;font-family: 'Work Sans', Sans-serif,serif;">
