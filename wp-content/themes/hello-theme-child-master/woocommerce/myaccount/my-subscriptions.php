...
?>
<h1 style="font-size: 2rem;padding-bottom:10px;">Subscriptions</h1>
...
<!--<h1 style="font-size: 2rem;padding-bottom:10px;padding-top:30px;">Changing Subscriptions</h1>
<p style="margin-bottom: 10px;">Switching plans with Visit Stay Explore is quick and easy. Simply fill in the form below and our support team will contact you to assist in the switch.</p>
--><?php /*echo do_shortcode('[elementor-template id="2834"]'); */?>
